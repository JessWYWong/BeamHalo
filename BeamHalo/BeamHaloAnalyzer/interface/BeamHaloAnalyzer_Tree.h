#ifndef BeamHaloAnalyzer_Tree_h
#define BeamHaloAnalyzer_Tree_h
...
class BeamHaloAnalyzer_Tree : public edm::EDAnalyzer {
 private:
 ...
 public:
  explicit BeamHaloAnalyzer_Tree(const edm::ParameterSet& iConfig);// : pset(iConfig) {}
