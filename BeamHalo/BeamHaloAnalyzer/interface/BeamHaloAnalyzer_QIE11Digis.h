#ifndef BeamHaloAnalyzer_QIE11Digis_h
#define BeamHaloAnalyzer_QIE11Digis_h
...
class BeamHaloAnalyzer_QIE11Digis : public edm::EDProducer {
public:
  explicit BeamHaloAnalyzer_QIE11Digis(const edm::ParameterSet&);
