#ifndef BeamHaloAnalyzer_HcalPhase1RecHits_h
#define BeamHaloAnalyzer_HcalPhase1RecHits_h
...
class BeamHaloAnalyzer_HcalPhase1RecHits : public edm::EDProducer {
 protected:
  ...
  BeamHaloAnalyzer_HcalPhase1RecHitAlgorithm algo;
 ...
 BeamHaloAnalyzer_HcalPhase1RecHits(const edm::ParameterSet& iConfig) :
...
typedef BeamHaloAnalyzer_HcalPhase1RecHits<HFPreRecHitCollection> BeamHaloAnalyzer_HFPhase1RecHits;
