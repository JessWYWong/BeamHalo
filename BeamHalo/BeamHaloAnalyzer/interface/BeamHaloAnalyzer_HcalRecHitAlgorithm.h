#ifndef BEAMHALOANALYZER_RECHITALGORITHM_H
#define BEAMHALOANALYZER_RECHITALGORITHM_H
...
class BeamHaloAnalyzer_HcalRecHitAlgorithm { 

 public:

  BeamHaloAnalyzer_HcalRecHitAlgorithm();
  ...
  std::unique_ptr<std::vector<float> > chi2;
  ...
  template <class RecoCollection > 
    ...
    for (; reco != reco_end ; ++reco ) {
      ...
      chi2   -> push_back ( reco   -> chi2   () );
//      std::cout << (reco -> time()) << std::endl;
