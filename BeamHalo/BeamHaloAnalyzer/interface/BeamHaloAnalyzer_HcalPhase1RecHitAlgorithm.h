#ifndef BEAMHALOANALYZER_HFPHASE1HITALGORITHM_H
#define BEAMHALOANALYZER_HFPHASE1HITALGORITHM_H
...
class BeamHaloAnalyzer_HcalPhase1RecHitAlgorithm { 

 public:

  BeamHaloAnalyzer_HcalPhase1RecHitAlgorithm();
