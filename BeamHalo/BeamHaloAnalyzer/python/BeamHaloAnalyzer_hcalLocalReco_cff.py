...
from BeamHalo.BeamHaloAnalyzer.BeamHaloAnalyzer_HBHEPhase1Reconstructor_cfi import hbheprereco as _phase1_hbheprereco
...
run2_HCAL_2018.toReplaceWith( hbheprereco, _phase1_hbheprereco )

_plan1_hcalLocalRecoSequence = _phase1_hcalLocalRecoSequence.copy()
_plan1_hcalLocalRecoSequence += hbheplan1
from Configuration.Eras.Modifier_run2_HE_2018_cff import run2_HE_2018
run2_HE_2018.toReplaceWith(hcalLocalRecoSequence, _plan1_hcalLocalRecoSequence)
